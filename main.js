...
async function getCurrentUser() {
    ...
    // console.log("Token payload:", await res.json());
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const syncFromHash = () => {
        ...
        if (hash === "login") {
            ...
            registerTab.checked = true; // default
        }
    };
    ...
    ---------------------------- */
    const loginLabel = document.querySelector('label[for="tab-login"]');
    const registerLabel = document.querySelector('label[for="tab-register"]');
    ...
    form.addEventListener("submit", async (e) => {
        ...
        const isLogin = loginTab.checked;
